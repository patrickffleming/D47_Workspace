...
<xsl:template name="function-level">    <!-- /OrderStatusRequest -->
  <rdml:field name="XBOHSITE" value="{/OrderStatusRequest/Site}"/>
  <rdml:field name="XBOHNUMB" value="{/OrderStatusRequest/OrderNumber}"/>
</xsl:template>
