...
public class UHAEmployeeServerServiceServiceLocator extends org.apache.axis.client.Service implements com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServiceService {
    ...
    private java.lang.String UHAEmployeeServerServicePort_address = "http://solutions.lansa.com:8561/jsmdirect";
    ...
    public com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServicePortType getUHAEmployeeServerServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServicePortType getUHAEmployeeServerServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServiceBindingStub _stub = new com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServiceBindingStub _stub = new com.lansa.UHASOAPServer.Tutorial.UHAEmployeeServerServiceBindingStub(new java.net.URL(UHAEmployeeServerServicePort_address), this);
                _stub.setPortName(getUHAEmployeeServerServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Tutorial.UHASOAPServer.lansa.com", "UHAEmployeeServerServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Tutorial.UHASOAPServer.lansa.com", "UHAEmployeeServerServicePort"));
        }
