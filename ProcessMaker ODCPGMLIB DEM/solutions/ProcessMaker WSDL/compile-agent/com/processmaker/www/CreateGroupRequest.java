...
public class CreateGroupRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the sessionId value for this CreateGroupRequest.
     * 
     * @return sessionId
     */
    ...
    /**
     * Sets the sessionId value for this CreateGroupRequest.
     * 
     * @param sessionId
     */
    ...
    /**
     * Gets the name value for this CreateGroupRequest.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this CreateGroupRequest.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.processmaker.com", ">createGroupRequest"));
